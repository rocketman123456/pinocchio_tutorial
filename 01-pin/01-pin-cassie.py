...
for j, cm in enumerate(constraint_models):
    ...
    print(red_color)
    robot.viewer.gui.addXYZaxis(name1, [red_color, 1.0, 1.0 - red_color, transparency], radius, axis_size)
    robot.viewer.gui.addXYZaxis(name2, [red_color, 1.0, 1.0 - red_color, transparency], radius, axis_size)
